...
// Orchestrator for a single node's info + config + traces. Owns the
// API conversation (patch, toggle) but delegates every chunk of UI
// to NodeHeader / ConfigForm / TraceStream.
//
// Mounted with key={node.id} by every caller so switching between
// nodes fully remounts this subtree — the only way React resets
// client form state when props change.
  ...
  return (
    <div className="h-full flex flex-col gap-4 p-4 md:p-6">
      ...
      <div className="flex-1 flex flex-col gap-4 overflow-hidden">
        ...
        <section className="flex-1 flex flex-col overflow-hidden border border-white/10 rounded min-h-[200px]">
